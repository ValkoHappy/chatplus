...
Для новых страниц и крупных правок лучше сначала создать `Generation Job`, проверить созданный draft в preview и только потом публиковать. Для доработки существующего AI-черновика выберите эту страницу в `target_page`: route сохранится, а prompt будет применен к текущему черновику.
