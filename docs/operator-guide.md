...
Этот документ для человека, который обновляет контент и публикует demo, не влезая глубоко в frontend-код.
...
- контент страницы -> контентщик / владелец Strapi
- шаблон или верстка -> frontend developer
- генератор / seeds -> инженер, который ведет content pipeline
- публикация / GitHub Pages / секреты -> devops или техлид
