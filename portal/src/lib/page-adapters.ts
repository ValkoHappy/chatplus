...
export function adaptChannelPage(channel: any, context: any) {
  ...
  return {
    ...
    h1: fill(template.h1, { name: channel.name }),
    ...
    problem_title: fill(template.problem_title, { name: channel.name }),
    problem_intro: fill(template.problem_intro, { name: channel.name }),
    problems: Array.isArray(template.problem_points) ? template.problem_points : [],
    problem_summary: fill(template.problem_summary, { name: channel.name }),
    solution_title: fill(template.solution_title, { name: channel.name }),
    solution_intro: fill(template.solution_intro, { name: channel.name }),
    solution_steps: makeSteps(channel.steps),
    features_title: template.features_title,
    features: makeFeatureItems(channel.features),
    integrations_title: fill(template.integrations_title, { name: channel.name }),
    integration_blocks: makeIntegrationBlocks(context.integrations),
    roi_title: fill(template.roi_title, { name: channel.name }),
    roi_intro: fill(template.roi_intro, { name: channel.name }),
    roi_with_items: makeRoiItems(channel.roi_metrics),
    faq_title: template.faq_title,
    ...
    sticky_cta_title: fill(template.sticky_cta_title, { name: channel.name }),
    sticky_cta_text: fill(template.sticky_cta_text, { name: channel.name }),
...
export function adaptIndustryPage(industry: any, context: any) {
  ...
  return {
    ...
    h1: fill(template.h1, { name: industry.name }),
    subtitle: industry.description,
    hero_cta_primary_label: industry.cta,
    hero_cta_primary_url: '/demo',
    hero_cta_secondary_label: template.hero_cta_secondary_label,
    hero_cta_secondary_url: template.hero_cta_secondary_url,
    problem_title: fill(template.problem_title, { name: industry.name }),
    problem_intro: industry.pain,
    problems: [{ title: template.problem_point_title, text: industry.pain }],
    solution_title: fill(template.solution_title, { name: industry.name }),
    solution_intro: industry.solution,
    features_title: template.features_title,
    features: makeFeatureItems(industry.features),
    integrations_title: fill(template.integrations_title, { name: industry.name }),
    integration_blocks: makeIntegrationBlocks(topChannels),
    use_cases_title: template.use_cases_title,
    ...
    sticky_cta_title: fill(template.sticky_cta_title, { name: industry.name }),
    sticky_cta_text: fill(template.sticky_cta_text, { name: industry.name }),
...
export function adaptIntegrationPage(integration: any, context: any) {
  ...
  return {
    ...
    h1: fill(template.h1, { name: integration.name }),
    subtitle: integration.description,
    hero_cta_primary_label: integration.cta,
    hero_cta_primary_url: '/demo',
    problem_title: fill(template.problem_title, { name: integration.name }),
    problem_intro: fill(template.problem_intro, { name: integration.name, category: integration.category || '' }),
    solution_title: fill(template.solution_title, { name: integration.name }),
    solution_intro: fill(template.solution_intro, { name: integration.name }),
    features_title: template.features_title,
    ...
    sticky_cta_title: fill(template.sticky_cta_title, { name: integration.name }),
    sticky_cta_text: fill(template.sticky_cta_text, { name: integration.name }),
...
export function adaptFeaturePage(feature: any, context: any) {
  ...
  return {
    ...
    h1: fill(template.h1, { name: feature.name }),
    subtitle: feature.description,
    hero_cta_primary_label: feature.cta,
    hero_cta_primary_url: '/demo',
    problem_title: fill(template.problem_title, { name: feature.name }),
    problem_intro: fill(template.problem_intro, { name: feature.name }),
    solution_title: fill(template.solution_title, { name: feature.name }),
    solution_intro: fill(template.solution_intro, { name: feature.name }),
    features_title: template.features_title,
    ...
    sticky_cta_title: fill(template.sticky_cta_title, { name: feature.name }),
    sticky_cta_text: fill(template.sticky_cta_text, { name: feature.name }),
...
export function adaptSolutionPage(solution: any, context: any) {
  ...
  return {
    ...
    h1: fill(template.h1, { name: solution.name }),
    subtitle: solution.description,
    hero_cta_primary_label: solution.cta,
    hero_cta_primary_url: '/demo',
    problem_title: fill(template.problem_title, { name: solution.name }),
    problem_intro: fill(template.problem_intro, { name: solution.name }),
    solution_title: fill(template.solution_title, { name: solution.name }),
    solution_intro: fill(template.solution_intro, { name: solution.name }),
    features_title: template.features_title,
    ...
    sticky_cta_title: fill(template.sticky_cta_title, { name: solution.name }),
    sticky_cta_text: fill(template.sticky_cta_text, { name: solution.name }),
...
export function adaptCompetitorPage(competitor: any, context: any, mode: 'compare' | 'vs') {
  ...
  return {
    ...
    problems: (competitor.weaknesses || []).map((item: string, index: number) => ({ title: `Пункт ${index + 1}`, text: item })),
